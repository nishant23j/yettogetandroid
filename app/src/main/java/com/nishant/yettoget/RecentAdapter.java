...
public class RecentAdapter extends CursorAdapter {
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        return LayoutInflater.from(context).inflate(R.layout.recent_list_item, parent, false);
    }
    ...
    public void bindView(View view, final Context context, Cursor cursor) {
        ...
        TextView textView = (TextView) view.findViewById(R.id.recent_textview);
      ...
      //  final String id = cursor.getString(RecentList.COL_recent);
        final String task = cursor.getString(RecentList.COL_RECENT_NAME);
